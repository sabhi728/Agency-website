      ...
      <div className="container flex h-16 items-center justify-between px-4 sm:px-6 lg:px-8">
        <div className="flex items-center gap-4 py-2">
          <Link href="/" className="flex items-center">
            <Logo className="h-8 w-auto" width={180} height={40} />
          </Link>
        </div>
        ...
        <div className="hidden lg:flex items-center gap-6">
          ...
          <Button className="bg-[#673ee5] hover:bg-[#5933c0]">Sign In</Button>
        </div>
        ...
        <div className="fixed inset-y-0 right-0 w-full overflow-y-auto bg-white px-6 py-6 sm:max-w-sm sm:ring-1 sm:ring-gray-900/10">
          <div className="flex items-center justify-between">
            <Link href="/" className="-m-1.5 p-1.5">
              <Logo className="h-6 w-auto" width={140} height={30} />
            </Link>
            <button
              type="button"
          ...
          <div className="mt-6 flow-root">
            <div className="-my-6 divide-y divide-gray-200">
              ...
              <div className="py-6">
                <Button className="w-full bg-[#673ee5] hover:bg-[#5933c0]" onClick={() => setMobileMenuOpen(false)}>
                  Sign In
                </Button>
              </div>
            </div>
