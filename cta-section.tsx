    ...
    <section className="py-12 sm:py-16 bg-[#673ee5]">
      <div className="container mx-auto px-4">
        <div className="max-w-4xl mx-auto text-center text-white">
          ...
          >
            Join thousands of satisfied users who have transformed their bill payment experience with US. Sign
          ...
          >
            ...
            <Button
              variant="outline"
              className="border-white text-white hover:bg-white/10 px-6 py-3 text-sm sm:text-base sm:px-8 sm:py-4 rounded-lg"
            >
              Learn More
            </Button>
          </motion.div>
